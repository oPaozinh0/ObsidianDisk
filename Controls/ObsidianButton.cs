...
public class ObsidianButton : System.Windows.Controls.Button
{
    ...
    private static readonly bool Light = App.IsLightTheme;

    private static readonly SolidColorBrush AccentBg = Light ? B(0xFF, 0x6C, 0x4C, 0xF0) : B(0xFF, 0x7C, 0x5C, 0xFF);
    private static readonly SolidColorBrush AccentHover = Light ? B(0xFF, 0x5A, 0x3B, 0xD6) : B(0xFF, 0x96, 0x78, 0xFF);
    private static readonly SolidColorBrush AccentPressed = Light ? B(0xFF, 0x4A, 0x2F, 0xC0) : B(0xFF, 0x67, 0x49, 0xD8);
    private static readonly SolidColorBrush GhostBg = Light ? B(0xFF, 0xE9, 0xEB, 0xF2) : B(0xFF, 0x1C, 0x22, 0x30);
    private static readonly SolidColorBrush GhostHover = Light ? B(0xFF, 0xDF, 0xE3, 0xEE) : B(0xFF, 0x24, 0x2C, 0x3E);
    private static readonly SolidColorBrush GhostPressed = Light ? B(0xFF, 0xD3, 0xD8, 0xE6) : B(0xFF, 0x16, 0x1B, 0x27);
    ...
    private static readonly SolidColorBrush TextNormal = Light ? B(0xFF, 0x1B, 0x21, 0x30) : B(0xFF, 0xE6, 0xEA, 0xF2);
    private static readonly SolidColorBrush TextMuted = Light ? B(0xFF, 0x9A, 0xA1, 0xB5) : B(0xFF, 0x8A, 0x93, 0xA8);
    private static readonly SolidColorBrush TextDanger = Light ? B(0xFF, 0xC0, 0x35, 0x40) : B(0xFF, 0xE0, 0x6C, 0x75);
    ...
    private static readonly Pen StrokePen = Light ? P(0xFF, 0xD5, 0xD9, 0xE4) : P(0xFF, 0x2A, 0x32, 0x45);
    private static readonly Pen StrokeHoverPen = Light ? P(0xFF, 0x6C, 0x4C, 0xF0) : P(0xFF, 0x7C, 0x5C, 0xFF);
    private static readonly Pen DangerPen = Light ? P(0xAA, 0xC0, 0x35, 0x40) : P(0xAA, 0xD6, 0x45, 0x50);
    private static readonly Pen FacetLight = P(0x66, 0xFF, 0xFF, 0xFF, 1.4);
    private static readonly Pen FacetGhost = Light ? P(0x50, 0x6C, 0x4C, 0xF0, 1.4) : P(0x50, 0x7C, 0x5C, 0xFF, 1.4);
    private static readonly Pen FacetDanger = Light ? P(0x70, 0xC0, 0x35, 0x40, 1.4) : P(0x70, 0xE0, 0x6C, 0x75, 1.4);
